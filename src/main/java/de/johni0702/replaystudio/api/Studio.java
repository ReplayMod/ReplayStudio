...
public interface Studio {
     ...
     * You want to disable packet wrapping if you depend on class names (e.g. packet dumper).
     * @param enabled {@code true} to enable wrapping, {@code false} otherwise disables packet wrapping
     */
